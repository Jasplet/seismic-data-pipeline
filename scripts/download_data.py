...
if __name__ == '__main__':
    ...
    # Time span to get data for. Edit these start/end objects to customise the timespan to get
    # data for.
    ...
    location = ["00"]
    # flatten seedlink parameters into an iterator of tuples of all possible combinations. 
