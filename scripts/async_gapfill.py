...
async def main():
    ...
    data_dir = Path("/Users/eart0593/Projects/Agile/NYMAR/" + "data_dump/gap_filling")
    ...
    request_params = [
        params for params in in_params if params[1] not in ["NYM1", "NYM4"]
    ]
    urls, outfiles = make_asnyc_urls(
        ips_dict,
        request_params,
        data_dir,
    ...
    semaphores = {
        sensor_ip: asyncio.Semaphore(2) for sensor_ip in requests_by_ip
    }  # Adjust as needed
...
if __name__ == "__main__":
    ...
    log.info(
        f"Runtime is {runtime:.2f} seconds,"
